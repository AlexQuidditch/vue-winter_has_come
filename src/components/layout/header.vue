  ...
  <header class="header">
		...
		<div class="header-row _second">
          ...
          <span>{{ currentUserIsAgent ? 'Посмотреть задания' : 'Найти работу' }}</span>
				...
				<router-link :to="{ name : 'users' , query: { section : 'all' }}" class="header-row__link waves-effect waves-light">Исполнители</router-link>
				<router-link :to="{ name : 'agents' , query: { section : 'all' } }" class="header-row__link waves-effect waves-light">Агенты</router-link>
