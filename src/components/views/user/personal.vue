<template lang="html">
	<section class="personal">
		...
		<div class="personal-info">
			<h3 class="personal-info__name">{{ User.personal.name + ' ' + User.personal.sename + ' ' + $route.query.id }}</h3>
			...
			<div class="personal-more">
				...
				<p class="personal-more__item">{{ User.information.education.place }}, {{ User.information.education.faculty }}</p>
			</div>
			<p class="personal-info__about">{{ User.information.about }}</p>
		</div>
		<ratings-block :Ratings="User.ratings" class="ratings-block"></ratings-block>
	</section>
</template>
